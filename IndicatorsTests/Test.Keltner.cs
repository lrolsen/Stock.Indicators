...
namespace StockIndicators.Tests
{
    ...
    public class KeltnerTests : TestBase
    {
        ...
        public void GetKeltnerTest()
        {
            ...
            // sample value
            KeltnerResult r1 = results.Where(x => x.Date == DateTime.ParseExact("12/31/2018", "MM/dd/yyyy", null)).FirstOrDefault();
            ...
            KeltnerResult r2 = results.Where(x => x.Date == DateTime.ParseExact("12/06/2018", "MM/dd/yyyy", null)).FirstOrDefault();
