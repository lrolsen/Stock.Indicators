...
namespace StockIndicators.Tests
{
    ...
    public class WilliamRTests : TestBase
    {
        ...
        public void GetWilliamRTest()
        {
            ...
            // sample values
            WilliamResult r1 = results.Where(x => x.Date == DateTime.ParseExact("12/31/2018", "MM/dd/yyyy", null)).FirstOrDefault();
            Assert.AreEqual((decimal)-52.0121, Math.Round((decimal)r1.WilliamR, 4));
            Assert.AreEqual(true, r1.IsIncreasing);

            WilliamResult r2 = results.Where(x => x.Date == DateTime.ParseExact("05/15/2018", "MM/dd/yyyy", null)).FirstOrDefault();
