...
namespace StockIndicators.Tests
{
    ...
    public class StochasticTests : TestBase
    {
        ...
        public void GetStochStandardTest()
        {
            ...
            // sample value
            StochResult r = results.Where(x => x.Date == DateTime.ParseExact("12/31/2018", "MM/dd/yyyy", null)).FirstOrDefault();
        ...
        public void GetStochNoSignalTest()
        {
            ...
            StochResult r1 = results.Where(x => x.Date == DateTime.ParseExact("12/31/2018", "MM/dd/yyyy", null)).FirstOrDefault();
            Assert.AreEqual(r1.Oscillator, r1.Signal);

            StochResult r2 = results.Where(x => x.Date == DateTime.ParseExact("12/10/2018", "MM/dd/yyyy", null)).FirstOrDefault();
