...
namespace StockIndicators.Tests
{
    ...
    public class ConnorsRsiTests : TestBase
    {
        ...
        public void GetConnorsRsiTest()
        {
            ...
            // sample value
            ConnorsRsiResult r1 = results1.Where(x => x.Date == DateTime.ParseExact("12/31/2018", "MM/dd/yyyy", null)).FirstOrDefault();
            ...
            ConnorsRsiResult r2 = results2.Where(x => x.Date == DateTime.ParseExact("12/31/2018", "MM/dd/yyyy", null)).FirstOrDefault();
